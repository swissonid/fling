...
class MyExpandIcon extends StatefulWidget {
  /// Creates an [MyExpandIcon] with the given padding, and a callback that is
  ...
  @override
  _MyExpandIconState createState() => new _MyExpandIconState();
}

class _MyExpandIconState extends State<MyExpandIcon> with SingleTickerProviderStateMixin {
